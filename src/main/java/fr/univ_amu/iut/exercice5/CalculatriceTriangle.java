...
public class CalculatriceTriangle extends Application {
  ...
  void configGrille() {
    ...
    grille
        ...
        .addAll(col, new ColumnConstraints(200), new ColumnConstraints(200));
  }
  ...
  void ajouterSliders() {
    ...
    grille.add(sliderX2, 1, 2);
    grille.add(labelX2, 0, 2);
    grille.add(sliderX3, 1, 3);
    grille.add(labelX3, 0, 3);
    grille.add(sliderY1, 1, 4);
    grille.add(labelY1, 0, 4);
    grille.add(sliderY2, 1, 5);
    grille.add(labelY2, 0, 5);
  ...
  void ajouterLabelsPoints() {
    ...
    grille.add(labelP2, 2, 0);
    grille.add(labelP3, 3, 0);
  }
